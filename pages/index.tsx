    ...
    return (
        <>
            ...
            <div className='flex min-h-screen flex-col bg-gradient-to-br from-blue-800 to-gray-700 lg:flex-row lg:justify-center'>
                <header className='flex flex-col justify-between p-8 lg:mx-auto lg:w-1/2'>
                    <div className='lg:ml-10'>
                        <div className='space-y-3'>
                            ...
                            <p className='text-md font-light text-slate-200'>
                                I specialize in crafting web solutions that are
                                not only intuitive and fast but also deliver
                    ...
                    <div id='about'>
                        ...
                        <div className='text-md text-slate-200'>
                            <p className='mb-2'>
                                ...
                                del desarrollo web, siempre enfocándome en React
                                y sus derivados, como Next.js. Esto ha sido el
                                lienzo para expresar mi pasión y dedicación
                                inquebrantable en la creación de interfaces
                                innovadoras, accesibles e intuitivas.
                            </p>
                            <p className='mb-2'>
                                Mi compromiso siempre está orientado a ofrecer
                                la mejor experiencia de usuario, ajustando
                                diseños para garantizar una interacción fluida y
                                rápida.
                            </p>
                            <p className='mb-2'>
                                Además de mi cargo en Globant como Web UI, he
                                tenido la oportunidad de desempeñar el papel de
                                mentor para estudiantes de ingeniería que buscan
                                adentrarse en el mundo del desarrollo frontend.
                                Comparto consejos que me fueron útiles, brindo
                                retroalimentación constante sobre su progreso y
                                ofrezco apoyo para que continúen aprendiendo y
                                alcancen su primera experiencia laboral.
                                Compartir conocimientos y ayudar a otros ha sido
                                otra de mis pasiones; motivándome a seguir
                        ...
                        <ul className='list-none space-y-4'>
                            <li>
                                ...
                                <p>
                                    ...
                                    adipisicing elit. Laudantium similique neque
                                    culpa. Excepturi voluptatibus sed natus
                                    incidunt iure unde corrupti tenetur laborum
                                    quibusdam. Modi vero, magnam accusamus
                                    perferendis sint nihil.
                                </p>
                            </li>
                            <li>
                                <span>2021 - 2022</span>
                    ...
                    <div id='projects' className='mt-8 text-slate-300'>
                        ...
                        <ul className='list-none space-y-4'>
                            <li className='list-item'>
                                ...
                                <p>
                                    Lorem, ipsum dolor sit amet consectetur
                                    adipisicing elit. Magnam quisquam porro
                                    soluta dolorum ut aut quaerat quas, id
                                    exercitationem neque! Nostrum libero
                                    repellat deserunt ea delectus assumenda ex
                                    aliquid distinctio!
                                </p>
                            </li>
                        </ul>
